      ...
      <div className="w-full px-4 sm:px-6" style={{ overflowX: 'hidden' }}>
        ...
        <div className="flex justify-between items-center h-14 sm:h-16 gap-2" style={{ overflowX: 'hidden' }}>
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            >
              {isDark ? (
                <svg viewBox="0 0 24 24" fill="none" className="w-4 h-4" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="4" fill="currentColor"/><path d="M12 2v2M12 20v2M4.22 4.22l1.42 1.42M18.36 18.36l1.42 1.42M2 12h2M20 12h2M4.22 19.78l1.42-1.42M18.36 5.64l1.42-1.42" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/></svg>
              ) : (
                <svg viewBox="0 0 24 24" fill="none" className="w-4 h-4" xmlns="http://www.w3.org/2000/svg"><path d="M21 12.79A9 9 0 1111.21 3a7 7 0 109.79 9.79z" fill="currentColor"/></svg>
              )}
            </button>
            {account ? (
        ...
        <div className="md:hidden pb-2.5 flex flex-col gap-1.5" style={{ overflowX: 'hidden', width: '100%' }}>
          ...
          <div className="flex items-center gap-4">
            ...
            <button onClick={toggleTheme} className="flex items-center justify-center w-5 h-5 text-slate-600" title="Toggle theme">
              {isDark ? (
                <svg viewBox="0 0 24 24" fill="none" className="w-4 h-4" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="4" fill="currentColor"/><path d="M12 2v2M12 20v2M4.22 4.22l1.42 1.42M18.36 18.36l1.42 1.42M2 12h2M20 12h2M4.22 19.78l1.42-1.42M18.36 5.64l1.42-1.42" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/></svg>
              ) : (
                <svg viewBox="0 0 24 24" fill="none" className="w-4 h-4" xmlns="http://www.w3.org/2000/svg"><path d="M21 12.79A9 9 0 1111.21 3a7 7 0 109.79 9.79z" fill="currentColor"/></svg>
