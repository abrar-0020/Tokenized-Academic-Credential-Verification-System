      ...
      <section style={{ overflowX: 'hidden' }} className="bg-white py-12 sm:py-16">
        <div className="px-5 sm:px-8">
          ...
          <div className="flex flex-col gap-4 max-w-sm mx-auto sm:max-w-none sm:flex-row sm:gap-5 md:max-w-4xl">
            {[
              { icon: '', step: '01', title: 'Institution Issues', desc: 'Authorized institutions issue non-transferable digital credentials as Soulbound NFTs to students.', color: 'bg-sky-50', accent: 'text-sky-600' },
