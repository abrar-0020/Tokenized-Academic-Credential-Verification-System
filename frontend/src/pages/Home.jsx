...
const Home = () => {
  ...
  return (
    <div className="w-full overflow-x-hidden">
      {/* Hero Section */}
      <div className="bg-gradient-to-br from-primary-600 to-primary-800 text-white py-8 sm:py-12 w-full">
        <div className="max-w-3xl mx-auto text-center px-4">
          ...
          {!account ? (
            <button
              ...
              className="bg-white text-primary-600 px-4 py-2 sm:py-2.5 rounded-lg font-semibold text-sm hover:bg-gray-100 transition"
            >
            ...
            <a
              href="/dashboard"
              className="bg-white text-primary-600 px-4 py-2 sm:py-2.5 rounded-lg font-semibold text-sm hover:bg-gray-100 transition inline-block"
            >
              Go to Dashboard
            </a>
          )}
      ...
      {/* Features Section */}
      <div className="py-6 sm:py-8 bg-white w-full">
        <div className="px-3 sm:px-4">
          <h2 className="text-xl sm:text-2xl font-bold text-center mb-6 sm:mb-8">How It Works</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 max-w-5xl mx-auto">
          {/* Feature 1 */}
          <div className="text-center px-2">
            <div className="w-14 h-14 sm:w-16 sm:h-16 bg-primary-100 rounded-full flex items-center justify-center mx-auto mb-3">
      ...
      {/* Benefits Section */}
      <div className="py-6 sm:py-8 bg-gray-50 w-full">
        <div className="px-3 sm:px-4">
      ...
      {/* CTA Section */}
      <div className="py-6 sm:py-8 bg-primary-600 text-white w-full text-center">
        <div className="px-4">
